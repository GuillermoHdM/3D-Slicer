...
Window::Window(ivec2 size, bool visible) {
    // Create window
    initialize_system();/*WARNING this was added later, probably there will be an error if we create multiple windows*/
...
Window::~Window() {
    ...
    Window::destroy_system();/*WARNING added this here, same risk as in the constructor*/
